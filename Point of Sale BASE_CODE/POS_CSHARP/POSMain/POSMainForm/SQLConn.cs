...
namespace POSMainForm
{
	static class SQLConn
	{
		...
		public static void getData()
		{
			...
			try {
				DBNameMySQL = Interaction.GetSetting(AppName, "DBSection", "DB_Name", "lab_K_db");
				...
				PwdMySQL = Interaction.GetSetting(AppName, "DBSection", "DB_Password", "Tangopapa1313");
			} catch {
		...
		public static void ConnDB()
		{
			...
			try {
				...
				Interaction.MsgBox("The system failed to establish a connection TO SERVER " + ServerMySQL + " DB: " + DBNameMySQL  , MsgBoxStyle.Information, "Database Settings");
			}
